        ...
        <ScrollView contentContainerStyle={{padding:1}} style={[styles.container]}>
            ...
            <View>
                <TouchableOpacity style={styles.buttonView2}>
                  ...
                  <Text style={styles.TextBotao}>Metas</Text>
               </TouchableOpacity>
            </View>
           ...
           <View>
              <TouchableOpacity style={styles.buttonView2}>
                ...
                <Text style={styles.TextBotao}>Qualidade</Text>
              </TouchableOpacity>
           </View>
            ...
            <View>
              <TouchableOpacity style={styles.buttonView2}>
                ...
                <Text style={styles.TextBotao}>Ativação</Text>
              </TouchableOpacity>
            </View>
            ...
            <View>
              <TouchableOpacity style={styles.buttonView2}>
                ...
                <Text style={styles.TextBotao}>Prospeccão</Text>
              </TouchableOpacity>
            </View>
            ...
            <View>
              <TouchableOpacity style={styles.buttonView2}>
                ...
                <Text style={styles.TextBotao}>Migração</Text>
              </TouchableOpacity>
            </View>
